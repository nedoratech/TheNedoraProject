      ...
      <div className="max-w-[1160px] mx-auto px-5 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[5fr_7fr] items-stretch gap-y-0">
          <ScrollReveal className="pt-10 pb-5 sm:pt-12 sm:pb-6 lg:py-18 lg:pr-16 lg:border-r lg:border-white/[0.08]">
            <div className="text-[0.65rem] tracking-[0.22em] uppercase font-bold text-[rgba(99,115,243,0.6)] mb-4 sm:mb-5 flex items-center gap-2 before:content-[''] before:w-6 before:h-0.5 before:bg-[rgba(99,115,243,0.6)]">
              {label}
            </div>
            <h2 className="text-[clamp(2rem,4vw,3.2rem)] font-bold tracking-[-0.04em] leading-[1.05] mb-5 sm:mb-8">
              {titleBefore}
