/**
 * Nedora wordmark — inline SVG using currentColor so it adapts to both
 * dark and light themes. Wrap with a text-* class to set the fill colour.
 */
export default function NedoraLogo({ className = '' }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 800 267.3"
